...
static char module_docstring[] =
    "This module calculates relaxation matrix using and relaxation rates C.";
...
static char EtaXYcalculation_docstring[] =
    "Calculates the transverse proton-carbon CSA/DD cross-correlation given a set of parameters (field and dynamics as an example).";
static char EtaZcalculation_docstring[] =
    "Calculates the longitudinal proton-carbon CSA/DD cross-correlation given a set of parameters (field and dynamics as an example).";    
...
static PyObject *EtaXYcalculation_EtaXYcalculation(PyObject *self, PyObject *args);
static PyObject *EtaZcalculation_EtaZcalculation(PyObject *self, PyObject *args);
...
static PyMethodDef module_methods[] = {
    ...
    {"EtaXYcalculation", EtaXYcalculation_EtaXYcalculation, METH_VARARGS, EtaXYcalculation_docstring},
    {"EtaZcalculation", EtaZcalculation_EtaZcalculation, METH_VARARGS, EtaZcalculation_docstring},
    {NULL, NULL, 0, NULL}
};
...
PyMODINIT_FUNC PyInit__EtaXYcalculation(void)
{
...
PyMODINIT_FUNC PyInit__EtaZcalculation(void)
{
...
static PyObject *RelaxMat_RelaxMat(PyObject *self, PyObject *args)
{
    ...
    MatrixFull = RelaxMatrix( BVal, Xarr, TaucArr, OtherInputsArr );
...
static PyObject *R1calculation_R1calculation(PyObject *self, PyObject *args)
{
    ...
    /* Call the external C function to compute the rate. */
    double R1val;
    R1val = R1calculation( BVal, Xarr, TaucArr, OtherInputsArr );
...
static PyObject *Sigmacalculation_Sigmacalculation(PyObject *self, PyObject *args)
{
    ...
    /* Call the external C function to compute the rate. */
    double Sigmaval;
    Sigmaval = Sigmacalculation( BVal, Xarr, TaucArr, OtherInputsArr );
...
static PyObject *EtaXYcalculation_EtaXYcalculation(PyObject *self, PyObject *args)
{
    ...
    /* Call the external C function to compute the rate. */
    double EtaXYVal;
    EtaXYVal = EtaXYcalculation( BVal, Xarr, TaucArr, OtherInputsArr );
    ...
    PyObject *ret = Py_BuildValue("d", EtaXYVal);
    return ret;
}
...
static PyObject *EtaZcalculation_EtaZcalculation(PyObject *self, PyObject *args)
{
    ...
    /* Call the external C function to compute the rate. */
    double EtaZVal;
    EtaZVal = EtaZcalculation( BVal, Xarr, TaucArr, OtherInputsArr );
    ...
    PyObject *ret = Py_BuildValue("d", EtaZVal);
    return ret;
}