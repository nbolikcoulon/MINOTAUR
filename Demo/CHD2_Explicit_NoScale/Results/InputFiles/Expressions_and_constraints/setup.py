...
setup(
    ext_modules=[Extension(CurrentDirectiory + "/Rates/_EtaZcalculation", [CurrentDirectiory + "/_Rates.c", CurrentDirectiory + "/Rates.c"])],
    include_dirs=numpy.get_include(),
)

setup(
    ext_modules=[Extension(CurrentDirectiory + "/Rates/_EtaXYcalculation", [CurrentDirectiory + "/_Rates.c", CurrentDirectiory + "/Rates.c"])],
    include_dirs=numpy.get_include(),
)
