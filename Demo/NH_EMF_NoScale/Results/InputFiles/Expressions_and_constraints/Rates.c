...
double AutoDD(double w, double *Xarr, double tauc)
{	
    double Sf2 = Xarr[0];
    double Ss2 = Xarr[1];
...
double AutoDD_HH(double w, double *Xarr, double tauc)
{	
    return AutoDD(w, Xarr, tauc);
}

double AutoCSA(double w, double *Xarr, double tauc)
{	
    return AutoDD(w, Xarr, tauc);
}

double CrossCSADD(double w, double *Xarr, double tauc, double angle)
{	
    return AutoDD(w, Xarr, tauc);
}
...
double R1calculation(double B, double *Xarr, double tauc, double *OtherInputs)
{
    ...
    double J_wn = AutoDD(w0_n, Xarr, tauc);
    double J_m = AutoDD(w0_h - w0_n, Xarr, tauc);
    double J_p = AutoDD(w0_h + w0_n, Xarr, tauc);
...
double R2calculation(double B, double *Xarr, double tauc, double *OtherInputs )
{
    ...
    double J_0 = AutoDD(0.0, Xarr, tauc);
    double J_wn = AutoDD(w0_n, Xarr, tauc);
    double J_wh = AutoDD(w0_h, Xarr, tauc);
    double J_m = AutoDD(w0_h - w0_n, Xarr, tauc);
    double J_p = AutoDD(w0_h + w0_n, Xarr, tauc);
...
struct mat2d RelaxMatrix(double B, double *Xarr, double tauc, double *OtherInputs) {
    ...
    double J_HH_0 = AutoDD_HH(0.0, Xarr, tauc);
    double J_HH_wh = AutoDD_HH(w0_h, Xarr, tauc);
    double J_HH_2wh = AutoDD_HH(2.0*w0_h, Xarr, tauc);
    
    double J_CSADD_wh_xx = CrossCSADD(w0_h, Xarr, tauc, theta_HxxHN);
    double J_CSADD_wh_yy = CrossCSADD(w0_h, Xarr, tauc, theta_HyyHN);
    double J_CSADD_wn = CrossCSADD(w0_n, Xarr, tauc, theta_NNH);
