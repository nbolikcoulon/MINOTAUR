...
static char R1Hcalculation_docstring[] =
    "Calculates the proton R1 given a set of parameters (field and dynamics as an example).";
...
static PyObject *R1Hcalculation_R1Hcalculation(PyObject *self, PyObject *args);
...
static PyMethodDef module_methods[] = {
    ...
    {"R1Hcalculation", R1Hcalculation_R1Hcalculation, METH_VARARGS, R1Hcalculation_docstring},
    {NULL, NULL, 0, NULL}
};
...
PyMODINIT_FUNC PyInit__R1Hcalculation(void)
{
...
static PyObject *R1Hcalculation_R1Hcalculation(PyObject *self, PyObject *args)
{
    ...
    /* Call the external C function to compute the rate. */
    double R1HVal;
    R1HVal = R1Hcalculation( BVal, Xarr, TaucArr, OtherInputsArr );
    ...
    PyObject *ret = Py_BuildValue("d", R1HVal);
    return ret;
}